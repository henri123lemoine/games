...
/// The gauge's anchored opponent panel. Elo values come from `chess calibrate`
/// (opponent-vs-opponent matches solved as Bradley-Terry, anchored at
/// Stockfish's UCI_Elo 1320); rerun after any rules change.
...
/// Maximum-likelihood Elo from scores against rated opponents: the unique root
/// of the score-vs-expectation excess.
...
/// Estimates the checkpoint's Elo from paired games against the anchored panel
/// (random, the alpha-beta ladder, Stockfish levels), fit by maximum likelihood
/// — meaningful even far below Stockfish's 1320 floor. Appends an
