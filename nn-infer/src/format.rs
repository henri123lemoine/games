...
/// Header byte count after the magic: ten `u32` fields.
const HEADER_FIELDS: usize = 10;
const HEADER_LEN: usize = MAGIC.len() + HEADER_FIELDS * 4;
...
impl Arch {
    ...
    /// Serializes the 44-byte header (magic + ten `u32`s). The exporter writes
